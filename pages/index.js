...
export default function Home() {
  return (
    <div className='flex items-center flex-col sjustify-center w-screen h-auto md:h-screen my-5 md:my-auto overflow-x-hidden p-2'>
      <Head>
      ...
      <div className='absolute right-20 top-20 flex gap-5 hidden md:flex'>
        <button className='btn btnClickMe bg-lightning text-darken hover:bg-darken hover:text-lightning p-2 transition-all'>Click Me</button>
        <a className='btn bg-lightning text-darken hover:bg-darken hover:text-lightning p-2 transition-all' href='cv.pdf' target='_blank'>Resume</a>
      </div>
      <main className='flex flex-col max-w-[960px] h-full'>
        <div className='text-left w-full md:min-h-full flex flex-col justify-center gap-3'>
          <h1 className='font-JetBrains text-2xl md:text-5xl font-bold' >Hey, how's it going? 👋</h1>
          <h3 className='font-JetBrains text-lg md:text-2xl font-light' >My name is Jonathan Tiago and i'm Front-End Dev & Designer.</h3>
          <div className="flex gap-2 items-center">
            <a href="mailto:asimplekreative@gmail.com">
              <svg xmlns="http://www.w3.org/2000/svg" fill="transparent" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" className="mailing w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
              </svg>
            </a>
            <a href="https://www.linkedin.com/in/jonathantiiago/" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#eeeeee" className='instagram w-5 h-5'>
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
              </svg>
            </a>
          </div>
        </div>
        <div className='text-left w-full h-[400px] md:min-h-full flex flex-col justify-center'>
        ...
        <div className='text-left w-full min-h-full flex flex-col justify-center '>
